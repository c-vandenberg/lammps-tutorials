...
def main():
    ...
    time, h2o_temperature = numpy.loadtxt(
        os.path.join(base_dir, '../../data/raw/temperature-vs-time/ave_H2O_temperature.dat')
    ).T
    ...
    _, h2o_volume = numpy.loadtxt(
        os.path.join(base_dir, '../../data/raw/volume-vs-time/ave_H2O_volume.dat')
    ).T
    ...
    _, h2o_density = numpy.loadtxt(
        os.path.join(base_dir, '../../data/raw/density-vs-time/ave_H2O_density.dat')
    ).T
