...
def main():
    ...
    lennard_jones_fluid_interactions_plot.single_line_graph(
        ...
        y_lim=(-1.055, 1.055),
        x_lim=(0, 6.1),
        graph_title=r'$\bf{Lennard-Jones\ Potential\ vs\ Intermolecular\ Distance}$',
    ...
    lennard_jones_fluid_interactions_plot.single_line_graph(
        ...
        y_lim=(-1.0, 0.0),
        x_lim=(0, 20),
        graph_title=r'$\bf{Lennard-Jones\ Fluid\ Potential\ Energy\ vs\ Time\ (During\ Energy\ Minimization\ &\ '
                    r'Molecular\ Dynamics\ Simulation)}$',
    ...
    lennard_jones_fluid_interactions_plot.single_line_graph(
        ...
        y_lim=(-0.05, 2.0),
        x_lim=(0, 20),
        graph_title=r'$\bf{Lennard-Jones\ Fluid\ Kinetic\ Energy\ vs\ Time\ (During\ Energy\ Minimization\ &\ '
                    r'Molecular\ Dynamics\ Simulation)}$',
