...
def main():
    ...
    md_universe: Universe = Universe(
        os.path.join(base_dir, '../../data/raw/topology/solvated_PEG.data'),
        os.path.join(base_dir, '../../data/raw/trajectory/solvated_PEG_dump.lammpstrj'),
    ...
    peg_hydrogen_atom_4_traj: list = SolvatedPEGTrajectoryPlot.get_first_atom_temporal_evolution_from_type(
    ...
    SolvatedPEGTrajectoryPlot.two_dimensional_scatter_plot(
    ...
    SolvatedPEGTrajectoryPlot.three_dimensional_scatter_plot(
        x_axis_values=x_coordinates,
        y_axis_values=y_coordinates,
